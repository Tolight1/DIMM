...
signals:
    ...
    void syncSampleReady(double syncDeltaUs);
...
public slots:
    ...
    void processFrame(int cameraIndex, cv::Mat frame, quint64 frameId = 0, quint64 cameraTimestamp = 0);
...
public slots:
    void processFrame(int cameraIndex, const cv::Mat& frame, quint64 frameId = 0, quint64 cameraTimestamp = 0);
...
private:
    ...
    double m_baselineSeparationMm = 269.0;
    double m_focalLengthCm = 269.0;
    double m_zenithAngleDeg = 50.0;
