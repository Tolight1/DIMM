...
struct PolarisSolverConfig {
    ...
    PolarisHotPixelTemplateConfig hotPixelTemplates[2];
};
...
private:
    ...
    PendingSolveTask m_pendingLatestTask[2];
    std::shared_ptr<std::atomic_bool> m_cancelledTokens[2];
    quint64 m_nextTaskId = 0;
    quint64 m_activeTaskId[2] = {0, 0};
