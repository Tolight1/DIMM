...
private:
    ...
    cv::Mat m_alignmentLastFrame[2];
    quint64 m_alignmentLastFrameId[2] = {0, 0};
    PolarisSolverController* m_polarisSolverController = nullptr;
    quint64 m_alignmentSolveGeneration = 0;
    PolarisSolveResult m_alignmentSolveResult[2];
    AlignmentCameraSolveRuntime m_alignmentSolveRuntime[2];
