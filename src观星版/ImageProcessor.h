...
enum class MeasurementRejectReason {
    None = 0,
    NoCentroid,
    RoiInvalid,
    QualityGate,
...
signals:
    ...
    void measurementDiagnosticReady(int cameraIndex,
                                    bool centroidDetected,
...
private:
    ...
    MeasurementRejectReason measurementRejectReason(const CentroidResult& centroid,
